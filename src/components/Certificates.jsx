        ...
        <div className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {education.map((e) => (
              <div
                key={e.title}
                className="bg-[#111827] rounded-xl p-5 border border-white/5 hover:border-blue-500/30 transition-all flex items-start gap-4"
              >
                <div className="w-12 h-12 bg-blue-600/15 rounded-xl flex items-center justify-center text-2xl flex-shrink-0">
                  {e.icon}
                </div>
                <div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {certificates.map((c) => (
              <div
                key={c.title}
                className="bg-[#111827] rounded-xl p-5 border border-white/5 hover:border-blue-500/30 hover:-translate-y-1 transition-all group"
              >
